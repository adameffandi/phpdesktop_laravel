<div id="blog-user-edit-{{$blog->id}}" class="modal" tabindex="-1" role="dialog">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <form class="" action="{{route('user.blog.edit', $blog->id)}}" method="post" enctype="multipart/form-data">
        {{csrf_field()}}
