    ...
    <div class="row all-blog-section">
      <div class="col-lg-12 col-md-12 col-sm-12">
        ...
        <div class="text-center"><br>
          {{-- <a href="#" class="read-more-btn" target="_blank" disabled>PHPDesktop With Remote Database (MySQL)</a> <br><br><br> --}}
          <a href="https://cloud.amkde.com/index.php/s/GyJKXnzYiXixd7o" class="read-more-btn-2" target="_blank">PHPDesktop With Local Database (SQLite)</a>
        </div>
      </div>
    </div>
